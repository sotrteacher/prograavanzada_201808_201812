...
struct Nota{
   ...
   * deber\'a inicializar tambi\'en el atributo entero intFecha con el 
   * valor entero 20190129.
   */
  Nota(string stringF);

  Nota(std::string rem,std::string dest,std::string content);
  Nota(int int_fecha,std::string rem,std::string dest,
       std::string content);
