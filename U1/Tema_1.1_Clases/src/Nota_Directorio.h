...
struct Nota_Directorio{
	...
	void add(const int intFech,const std::string& rem,
	         const std::string& dest,const std::string& content);
	...
	/**Escribir el contenido del directorio de Notas en el archivo de datos (source_name)*/
	void save();
